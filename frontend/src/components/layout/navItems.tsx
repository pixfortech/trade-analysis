...
export const navItems: NavItem[] = [
  ...
  { id: "ai-recommendation", label: "AI Recommendation", icon: <I d="M12 3a6 6 0 00-3 11.2V17h6v-2.8A6 6 0 0012 3zM9 21h6" /> },
  ...
  { id: "manual-trade-tracker", label: "Trade Tracker", icon: <I d="M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" /> },
